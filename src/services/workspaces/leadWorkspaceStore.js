...
function normalizeWorkspace(input = {}) {
  ...
  return {
    ...
    consulting: {
      stage: normalizeConsultingStage(consulting.stage),
      status,
      websiteUrl: cleanUrl(consulting.websiteUrl),
      instagramUrl: cleanUrl(consulting.instagramUrl),
      instagramNotes: cleanText(consulting.instagramNotes, 10_000),
      auditSnapshot: cleanText(consulting.auditSnapshot, 80_000),
      ...
      visualSummary: cleanText(consulting.visualSummary, 6000),
      report: cleanText(consulting.report, 50_000),
      ...
      lastContactAt: cleanTimestamp(consulting.lastContactAt),
      ...
      reportProviderName: cleanText(consulting.reportProviderName, 180),
      reportModel: cleanText(consulting.reportModel, 180),
      diagnosisAiUsed: cleanBoolean(consulting.diagnosisAiUsed),
      reportAiUsed: cleanBoolean(consulting.reportAiUsed),
